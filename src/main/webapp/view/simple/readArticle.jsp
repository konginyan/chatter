    ...
    <div class="container-fluid">
        ...
        <s:if test="#session.account==null">
            <ul class="nav navbar-nav navbar-right">
                <li id="li1"><a href="registerPage?requestUrl=readArticle?id=<s:property value="#request.article.id"/>"> 注册</a></li>
                <li id="li2"><a href="loginPage?requestUrl=readArticle?id=<s:property value="#request.article.id"/>"> 登录</a></li>
        ...
        <s:else>
            <ul class="nav navbar-nav navbar-right">
                ...
                <li id="li4"><a href="logout?responseUrl=readArticle?id=<s:property value="#request.article.id"/>">退出</a></li>
            </ul>
        </s:else>
